...
#define IREE_HAL_VULKAN_SEMAPHORE_FAILURE_VALUE UINT64_MAX
...
iree_hal_vulkan_native_semaphore_cast(iree_hal_semaphore_t* base_semaphore) {
  return (iree_hal_vulkan_native_semaphore_t*)base_semaphore;
}
...
iree_status_t iree_hal_vulkan_native_semaphore_create(
  ...
  *out_semaphore = NULL;
  ...
  IREE_RETURN_AND_END_ZONE_IF_ERROR(
      z0, VkResultToStatus(logical_device->syms()->vkCreateSemaphore(
...
static iree_status_t iree_hal_vulkan_native_semaphore_query(
  ...
  *out_value = 0;
  ...
  uint64_t value = 0;
  IREE_RETURN_IF_ERROR(VkResultToStatus(
...
static iree_status_t iree_hal_vulkan_native_semaphore_signal(
  ...
  return VkResultToStatus(semaphore->logical_device->syms()->vkSignalSemaphore(
...
const iree_hal_semaphore_vtable_t iree_hal_vulkan_native_semaphore_vtable = {
    ...
    /* .wait_with_deadline = */
    iree_hal_vulkan_native_semaphore_wait_with_deadline,
    /* .wait_with_timeout = */
    iree_hal_vulkan_native_semaphore_wait_with_timeout,
};
